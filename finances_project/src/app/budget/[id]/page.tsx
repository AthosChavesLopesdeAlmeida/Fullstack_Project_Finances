...
const Page = () => {
  ...
  const CATEGORY_COLORS: Record<string, string> = {
    Food: 'bg-orange-500/35 text-orange-600 border-orange-500/20',
    Transport: 'bg-blue-500/35 text-blue-600 border-blue-500/20',
    Housing: 'bg-purple-500/35 text-purple-600 border-purple-500/20',
    Health: 'bg-red-500/35 text-red-600 border-red-500/20',
    Education: 'bg-yellow-500/35 text-yellow-700 border-yellow-500/20',
    Leisure: 'bg-pink-500/35 text-pink-600 border-pink-500/20',
    Shopping: 'bg-teal-500/35 text-teal-600 border-teal-500/20',
    Bills: 'bg-slate-500/35 text-slate-600 border-slate-500/20',
    Other: 'bg-gray-500/35 text-gray-600 border-gray-500/20',
  }
              ...
              <TableBody>
                {expenses.map((exp: Expense) => (
                  <TableRow key={exp.id}>
                    ...
                    <TableCell><Badge variant="default" className={CATEGORY_COLORS[exp.category]}>{exp.category}</Badge></TableCell>
